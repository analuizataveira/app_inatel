            ...
            <nav aria-label="Global" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center">
                        <a href="/" className="flex-shrink-0 text-indigo-600 hover:text-indigo-800">
                            <Logo />
                        </a>
                    </div>
                    ...
                    <div className="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                        <PopoverGroup className="flex space-x-4">
                            <Popover className="relative">
                                <PopoverButton className="flex items-center text-sm font-medium text-gray-900 hover:text-indigo-600">
                            ...
                            <a href="/login" onClick={handleLogout} className="text-sm font-medium text-gray-900 hover:text-indigo-600">
                                Sair
                            </a>
                        </PopoverGroup>
                    </div>
                ...
                <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-4 py-4 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                    <div className="flex items-center justify-between">
                        <a href="/" className="-m-1.5 p-1.5">
                            <svg className="svg_logo_inatel" xmlns="http://www.w3.org/2000/svg" viewBox="100 150 390 116">
                                <path className="path_logo"
                                ...
                                <Disclosure as="div" className="-mx-3">
                                    ...
                                    <DisclosurePanel className="mt-2 space-y-2">
                                        {products.map((item) => (
                                            <DisclosureButton
                                                key={item.name}
                                                as={Link}  // Alterado para Link
                                                to={item.href}  // Usando to em vez de href
